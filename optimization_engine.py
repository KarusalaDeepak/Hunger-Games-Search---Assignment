...
class OptimizationEngine:
    ...
    def load_hyperparameters(self):
        ...
        for algo_name in self.algorithms.keys():
            file_path = f"hgs/hyperparameters.json"
    ...
    def run_single_optimization(self, algo_name, func_name, func_details):
        ...
        self.logger.info(f"Standard Deviation Fitness: {std_dev_fitness:.6f}")
        ...
        return {
            ...
            'Standard Deviation Fitness': std_dev_fitness,
    ...
    def save_results_to_csv(self, results: List[Dict[str, Any]]):
        ...
        fieldnames = ['Timestamp', 'Log File', 'Algorithm', 'Function', 'Dimension', 
                    ...
                    'Mean Fitness', 'Median Fitness', 'Standard Deviation Fitness', 'Worst Fitness',
        ...
        with open(csv_filename, 'w', newline='') as csvfile:
            ...
            for result in results:
                row = {
                    ...
                    'Standard Deviation Fitness': result['Standard Deviation Fitness'],
